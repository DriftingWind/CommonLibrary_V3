...
import com.common.util.SDStorageUtil;
...
public class PhotoAlbumActivity extends Activity {
	private static PhotoAlbumActivityListener listener = null;

	public static void setPhotoAlbumActivityListener(
			PhotoAlbumActivityListener listener) {
		PhotoAlbumActivity.listener = listener;
	}

	public interface PhotoAlbumActivityListener {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		Custom_TitleBar_1 custom_TitleBar_1 = (Custom_TitleBar_1) findViewById(R.id.custom_titlebar_1_photo_album);
	...
	private int getImageCount(File folder) {
		...
		for (File file : files) {
			if (ImageUtil.isImage(file.getName())) {
				count++;
			}
		}
