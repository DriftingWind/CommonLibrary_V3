package com.common.util.updatesoft;
...
//	}
	 ...
	 * 显示软件更新对话框
	 */
	public void showNoticeDialog(String apkUrl,String apkName) {
		this.apkUrl = apkUrl;
		...
		public void run() {
			try {
				...
				if (Environment.getExternalStorageState().equals(
					...
					fos = mContext.openFileOutput(apkName,
